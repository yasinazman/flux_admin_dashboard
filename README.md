...
## Technologies Used
- **HTML5 & CSS3**
- **Bootstrap 5.3.8** (Front-end Framework)
- **JavaScript (ES6)** (Logic & DOM Manipulation)
- **Chart.js** (Data Visualisation)
- **FontAwesome 6.7.2** (Icons)
- **System Fonts** (Segoe UI, Tahoma, etc.)

## Disclaimer
This project is a prototype developed for educational purposes. Data changes (adding/deleting items) are simulated in the browser memory and will reset upon refreshing the page.
